...
export function clamp(value, min, max) {
    if (
        ...
        throw new TypeError("Todos los arguments deben ser numeros finitos.");
    }
    ...
    export function roundTo(value, decimals) {
        if (!Number.isFinite(value) || !Number.isFinite(decimals)) {
            throw new TypeError("Todos los argumentos deben ser numeros finitos.");
        }

        if (decimals < 0) {
            throw new TypeError("Los decimales deben ser un numero no negativo.");
        }
